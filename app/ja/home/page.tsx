  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
      <header className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">日本豆知識クイズ</h1>
        <Link href="/" passHref>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold">ここから始めましょう</h2>
        <Card className="bg-[url('/images/Japan_kyoto.png')] bg-cover bg-center rounded-xl overflow-hidden">
          <CardContent className="p-4 sm:p-6 bg-black bg-opacity-50 h-[200px] sm:h-[300px] flex flex-col justify-between">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">日本豆知識クイズ</h3>
              <p className="text-sm sm:text-base text-white mb-4">日本の旅を7倍楽しもう！日本人にとっては常識となっている興味深いトリビアを学び、観光中に答え合わせしましょう！</p>
            </div>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold">トピック別クイズ</h2>
        <div className="grid grid-cols-2 gap-4"> {/* ここを修正して2列にしています */}
          <Card className="bg-[url('/images/Coming_Soon2.png')] bg-cover bg-center overflow-hidden">
            <CardContent className="p-4 sm:p-6 h-[200px] sm:h-[300px] flex items-end">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">場所</h3>
            </CardContent>
          </Card>
          <Card className="bg-[url('/images/Coming_Soon.png')] bg-cover bg-center overflow-hidden">
            <CardContent className="p-4 sm:p-6 h-[200px] sm:h-[300px] flex items-end">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">文化と歴史</h3>
            </CardContent>
          </Card>
        </div>
      </section>
