    ...
    <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          <Card className="bg-[url('/images/Coming Soon2.png')] bg-cover bg-center overflow-hidden">
          ...
          <Card className="bg-[url('/images/Coming Soon.png')] bg-cover bg-center overflow-hidden">
            <CardContent className="p-4 sm:p-6 h-[200px] sm:h-[300px] flex items-end">
